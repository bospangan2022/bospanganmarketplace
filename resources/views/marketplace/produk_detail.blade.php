            ...
            <div id="ProductSection-product-template" class="product-template__container prstyle1 container">
                                ...
                                <div class="product-details-img">
                                    ...
                                    <div class="zoompro-wrap product-zoom-right pl-20">
                                        <div class="zoompro-span">
                                            <img class="gbr-detail zoompro blur-up lazyload"
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-md-3 col-lg-3 feature">
                            <img src="{{ asset('assets/marketplace/images/phone-call.png') }}" alt="Hotline"
                                title="Hotline" />
                            <div class="details">
                                <h3>Customer Service</h3>Hubungi <b>+62 813-3817-6731</b> Apabila Terdapat Masalah
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="tabs-listing">
                    <ul class="product-tabs">
                        <li rel="tab1"><a class="tablink">Deskripsi Produk</a></li>
                    </ul>
