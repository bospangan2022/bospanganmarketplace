...
<div class="pageWrapper">
	...
	<div class="search">
        <div class="search__form">
            <form class="search-bar__form" action="{{ url('search') }}">
                ...
                <input class="search__input" type="text" name="cari" placeholder="Masukkan Nama Barang Yang Anda Cari" aria-label="Search" autocomplete="off">
            </form>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-4 col-md-4 col-lg-4 d-none d-lg-none d-md-block d-lg-block">
                	<div class="text-center"><p class="top-header_middle-text"> Bos Pangan Masalah Pangan Beres</p></div>
                </div>
    	...
    	<div class="container-fluid">        
            <div class="row align-items-center">
                ...
                <div class="logo col-md-2 col-lg-2 d-none d-lg-block">
                    <a href="{{ url('/') }}">
                    	<img src="{{ asset('assets/marketplace/images/logo.svg') }}" alt="Belle Multipurpose Html Template" title="Belle Multipurpose Html Template" />
                    </a>
                </div>
                <!--End Desktop Logo-->
                <div class="col-2 col-sm-3 col-md-3 col-lg-8">
                	...
                	<nav class="grid__item" id="AccessibleNav"><!-- for mobile -->
                        ...
                        <li class="lvl1 parent megamenu">
                            <a href="{{ url('aboutus') }}">Tentang Kami <i class="anm anm-angle-down-l"></i></a>
                        </li>
                        </ul>
                    </nav>
                    <!--End Desktop Menu-->
                ...
                <?php if (!Auth::check()) { ?>
                        ...
                        <div id="header-love" class="block block-cart">
                        	<ul class="mini-products-list">
                                <li class="item">
                                	<h6 class="text-muted text-center mb-3">Untuk Melakukan Transaksi Silahkan Login Dahulu</h6>
                                </li>
                            </ul>
                            <div class="total">
                                 ...
                                 <div class="buttonSet text-center">
                                    ...
                                    <a href="{{ url('register') }}" class="btn btn-secondary btn--small">Create Account</a>
                                </div>
                            </div>
                        </div>
                        <!--End Minicart Popup-->
    ...
    <div class="mobile-nav-wrapper" role="navigation">
        ...
        <ul id="MobileNav" class="mobile-nav">
        	<li class="lvl1 parent megamenu"><a href="{{ url('/') }}">Home <i class="anm anm-angle-right-l"></i></a>
          
        </li>
        	<li class="lvl1 parent megamenu"><a href="{{ url('belanja') }}">Belanja <i class="anm anm-angle-right-l"></i></a>
          
        </li>
        	<li class="lvl1 parent megamenu"><a href="{{ url('aboutus') }}">Tentang Kami <i class="anm anm-angle-right-l"></i></a>
        </li>
      </ul>
	</div>
	<!--End Mobile Menu-->
                        ...
                        <div class="col-12 d-flex justify-content-center align-items-center">
                            <div class="footer-social">
                                <ul class="list--inline site-footer__social-icons social-icons">
                                    <li><a class="social-icons__link" href="https://www.facebook.com/people/Bos-Pangan/100073475478664/?sk=about" target="_blank" title="Belle Multipurpose Bootstrap 4 Template on Facebook"><i class="icon icon-facebook"></i></a></li>
                                    <li><a class="social-icons__link" href="https://twitter.com/bospangan" target="_blank" title="Belle Multipurpose Bootstrap 4 Template on Twitter"><i class="icon icon-twitter"></i> <span class="icon__fallback-text">Twitter</span></a></li>
                                    <li><a class="social-icons__link" href="https://www.instagram.com/bospangan/" target="_blank" title="Belle Multipurpose Bootstrap 4 Template on Instagram"><i class="icon icon-instagram"></i> <span class="icon__fallback-text">Instagram</span></a></li>
                                    <li><a class="social-icons__link" href="https://www.youtube.com/channel/UCnSct6D9nTIi8i4u-QS6MHA/featured" target="_blank" title="Belle Multipurpose Bootstrap 4 Template on YouTube"><i class="icon icon-youtube"></i> <span class="icon__fallback-text">YouTube</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <div class="site-footer">
        	<div class="container">
                	...
                	<div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-3 col-lg-3 contact-box">
                            ...
                            <ul class="addressFooter">
                            	<li><i class="icon anm anm-map-marker-al"></i><p>Jl Cimalaya No.13 ,<br>Kecamatan Kepanjen Kidul ,<br> Kota Blitar , 66116</p></li>
                                <li class="phone"><i class="icon anm anm-phone-s"></i><p>083833833833</p></li>
                                <li class="email"><i class="icon anm anm-envelope-l"></i><p>bospangan2022@gmail.com</p></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="footer-bottom">
                	<div class="row">
                    	<!--Footer Copyright-->
	                	<div class="col-12 col-sm-12 col-md-12 col-lg-12 order-1 order-md-0 order-lg-0 order-sm-1 copyright text-center"><span></span> <a href="templateshub.net">Bos Pangan Group  </a></div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="product-details-img">
                            <div class="pl-20">
                                <img src="assets/marketplace/images/product-detail-page/camelia-reversible-big1.jpg" alt="" />
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="swatch clearfix swatch-0 option1" data-option-index="0">
                                    <div class="product-form__item">
                                      ...
                                      <div data-value="Red" class="swatch-element color red available">
                                        ...
                                        <label class="swatchLbl color medium rectangle" for="swatch-0-red" style="background-image:url(assets/marketplace/images/product-detail-page/variant1-1.jpg);" title="Red"></label>
                                      </div>
                                      <div data-value="Blue" class="swatch-element color blue available">
                                        <input class="swatchInput" id="swatch-0-blue" type="radio" name="option-0" value="Blue">
                                        <label class="swatchLbl color medium rectangle" for="swatch-0-blue" style="background-image:url(assets/marketplace/images/product-detail-page/variant1-2.jpg);" title="Blue"></label>
                                      </div>
                                      <div data-value="Green" class="swatch-element color green available">
                                        <input class="swatchInput" id="swatch-0-green" type="radio" name="option-0" value="Green">
                                        <label class="swatchLbl color medium rectangle" for="swatch-0-green" style="background-image:url(assets/marketplace/images/product-detail-page/variant1-3.jpg);" title="Green"></label>
                                      </div>
                                      <div data-value="Gray" class="swatch-element color gray available">
                                        <input class="swatchInput" id="swatch-0-gray" type="radio" name="option-0" value="Gray">
                                        <label class="swatchLbl color medium rectangle" for="swatch-0-gray" style="background-image:url(assets/marketplace/images/product-detail-page/variant1-4.jpg);" title="Gray"></label>
                                      </div>
                                    </div>
                                </div>
	...
	<div class="newsletter-wrap" id="popup-container">
      <div id="popup-window">
        ...
        <div class="display-table splash-bg">
          <div class="display-table-cell width40"><img src="assets/marketplace/images/newsletter-img.jpg" alt="Join Our Mailing List" title="Join Our Mailing List" /> </div>
