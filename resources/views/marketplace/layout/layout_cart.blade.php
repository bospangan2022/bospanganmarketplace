...
<div class="pageWrapper">
    	...
    	<div class="container-fluid">        
            <div class="row align-items-center">
                ...
                <div class="logo col-md-2 col-lg-2 d-none d-lg-block">
                    <a href="{{ url('/') }}">
                    	<img src="assets/marketplace/images/logo.svg" alt="Belle Multipurpose Html Template" title="Belle Multipurpose Html Template" />
                    </a>
                </div>
                <!--End Desktop Logo-->
                                ...
                                <div class="swatch clearfix swatch-0 option1" data-option-index="0">
                                    <div class="product-form__item">
                                      ...
                                      <div data-value="Red" class="swatch-element color red available">
                                        ...
                                        <label clrass="swatchLbl color medium rectangle" for="swatch-0-red" style="background-image:url(assets/marketplace/images/product-detail-page/variant1-1.jpg);" title="Red"></label>
                                      </div>
    ...
    <!-- Select2 Javascript -->
     ...
     <!-- <script src="{{ asset('assets/marketplace/js/app.js') }}"></script> -->
     <!-- fontawesome -->
