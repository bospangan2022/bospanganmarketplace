                ...
                <div class="row d-flex">
                    <div class="new-item col-8">
                        ...
                        <div class="image-list-mobile card my-2">
                            ...
                            <div class="bukti-pelanggan text-center">
                                <h4>Bukti Transfer Pelanggan :</h4>
                                <img style="width:200px; height: 250px;" src="/images/post/{{ $pes->bukti }}"
                                    class="img-bukti" alt="">
                            </div>
                        </div>
                        ...
                        <div class="form-input card mb-4">
                            <div class="card-body">
                                ...
                                @foreach ($detail as $det)
                                    <div class="form-list mb-1 border-bottom">
                                        <div class="row mb-5">
                                            <div class="product-detail col-3">
                                                <img src="/images/post/{{ $det->foto }}" style="width: 100px;" alt="">
                                            </div>
                                            <div class="product-detail col-5 d-flex flex-column ">
                                                <strong class="mb-2 ">{{ $det->nama_barang }} </strong>
                                                <div class="row">
                                                    <div class="col-3 d-flex">
                                                        <p class="text-muted mb-2 ">SKU:</p>
                                            ...
                                            <div class="col-4 product-detail d-flex justify-content-end ">
                                                <strong class="mb-2 ">@currency($det->sub_harga) </strong>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @foreach ($status as $st)
                                    @if ($st->status == 'belumdibayar')
                                        <div class="d-flex flex-column border-bottom mt-3">
                                            ...
                                            <form action="{{ url('konfirmasi/pesanan', $pes->id_checkout) }}"
