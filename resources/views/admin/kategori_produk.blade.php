                    ...
                    <div class="col-9 bg-white border ">
                        ...
                        <div class="category-content m-3">
                            <div class="col-8 ms-3">
                                <a href="{{ url('tambah_produk') }}"><button type="button"
                                        class="btn btn-primary btn-sm">Buat Produk</button></a>
                            </div>
                            <div class="table-responsive  m-3">
                                <table class="table table-striped border" id="table-datatables" width="100%"
                                    cellspacing="0">
                                    <thead align="center">
                                        <tr>
                                            <th>SKU</th>
                                    ...
                                    <tbody align="center">
                                        @foreach ($produk as $prd)
                                            <tr>
                                                ...
                                                <td>
                                                    <div
                                                        class="button d-sm-flex justify-content-center align-content-center mb-4">
                                                        <a href="{{ url('hapus_kategoriProduk', $prd->id_barang) }}"
                                                            type="submit" class="btn btn-danger btn-icon-split p-3 hapus">
