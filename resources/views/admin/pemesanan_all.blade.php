...
@section('content')
    <div class="main-panel">
        <div class="content-wrapper">
            <div class="row mb-5">
                <h4 class="title">Semua Pemesanan</h4>
                                    ...
                                    <div class="row ms-2 mb-3 justify-content-lg-between">
                                        ...
                                        <div class="col-md-7">
                                            <div class="store mb-3">
                                                <a data-toggle="modal" data-target="#toko{{ $pes->id_toko }}"><span
                                                        class="me-3 fs-3">
                                                        <b>{{ $pes->nama_toko }}</b></span></a>
                                            </div>
                                            ...
                                            $jumlah = DB::table('tb_detail_checkout')
                                                ->where('id_checkout', $pes->id_checkout)
                                                ->count(); ?>
...
>>>>>>> 90dc88ab23132e2d218261b6c44e0777d864ef78
    ...
    @endforeach
    @foreach ($toko as $t)
        <div class="modal fade" id="toko{{ $t->id_toko }}" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
