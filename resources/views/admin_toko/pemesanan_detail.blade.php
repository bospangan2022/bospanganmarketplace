                            ...
                            <div class="card-body">
                                ...
                                <div class="form-list my-3 ">
                                    ...
                                    <div class="">
                                        ...
                                        <p class=" me-2 text-muted "><i class="ti-lock me-1"></i> Catatan pesanan tidak
                                            dapat dilihat oleh pelanggan.</p>
                                    </div>
                        ...
                        <div class="form-input card mb-4">
                            <div class="card-body">
                                <div class="form-list mb-1 border-bottom">
                                    ...
                                    <div class="row mb-5">
                                        <div class="col-3">
                                            <img src="{{ asset('assets/images/barang/barang1.jpg') }}" style="width: 100px;"
                                                alt="">
                                        </div>
                        ...
                        <div class="form-input card mb-4">
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-column mt-3">
                                    ...
                                    <p class="mb-2">Customer choice: Pengiriman daerah Blitar : Sanankulon, Garum,
                                        Kanigoro, Nglegok,Rp.8000</p>
                                    <p class="mb-2">Berat: 1.00 Kg</p>
                                    <a href="#" class="mb-2">
                                        <p>tandai sebagai dikirim</p>
                                    </a>
                                </div>
                                <div class="d-flex flex-column border-bottom mt-3">
                                    ...
                                    <a href="#" class="mb-2">
                                        <p> tunjukkan di peta<i class="ti-location-pin"></i></p>
                                    </a>
                                </div>
                                <div class="d-flex flex-column border-bottom mt-3">
