                            ...
                            <div id="collapseZero" class="accordion-collapse collapse show" aria-labelledby="headingZero"
                                ...
                                <div class="accordion-body">
                                    <div class="tags d-flex justify-content-between my-2">
                                        <a href="{{ url('produk_user') }}" style="text-decoration: none">All Products</a>
                                        <span>{{ $jumlah }}</span>
                                    </div>
                                    <div class="tags d-flex justify-content-between my-2">
                                        <a href="{{ url('produk_display') }}" style="text-decoration: none">Displayed on
                                            storefront</a>
                                        <span>{{ $tampil }}</span>
                                    </div>
                                    <div class="tags d-flex justify-content-between my-2">
                                        <a href="{{ url('produk_habis') }}" style="text-decoration: none">Out of stock</a>
                                        <span>{{ $habis }}</span>
                                    </div>
                                    <div class="tags d-flex justify-content-between my-2">
